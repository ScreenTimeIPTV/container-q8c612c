...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-q8c612c.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-q8c612c.containers.anotherwebservice.com/
...
```
git clone git@github.com:ScreenTimeIPTV/container-q8c612c.git
cd container-q8c612c
```
...
```
docker attach container-q8c612c
```
